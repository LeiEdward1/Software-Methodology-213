...
public class Roster {
    ...
    public String print() {
        String prints = "";
        prints+="*Student roster sorted by last name, first name, DOB **\n";
        for (int i = 0; i < size; i++) {
            int index = i;
        ...
        for (int i = 0; i < size; i++) {
            ...
            prints = prints+roster[i].toString()+"\n";
        }
        prints+="* end of list*\n";
        return prints;
    }
     ...
     */
    public String printBySchoolMajor() { //print roster sorted by school & major
        String prints = "";
        prints+="*Student roster sorted by last name, first name, DOB **\n";
     ...
     */
    public String printList(String school) {
        String prints = "";
        prints+="* Students in " + school + " *"+"\n";
        ...
        for (int i = 0; i < size; i++) {
            if (roster[i].getSchool().equals(school)) prints+=roster[i].toString()+"\n";
        }
        prints+="* end of list**";
        return prints;
    }
    ...
    public String printSemesterEnd(Enrollment enrollment){
        String prints = "";
        for(int i = 0; i < size; i++){
             ...
             if (enrollStudent != null){
                 ...
                 prints += semesterEnd(roster[i], creditsEnrolled);
             }
        }
        return prints;
    }
    public String semesterEnd(Student student, int creditsEnrolled){
        String prints = "";
