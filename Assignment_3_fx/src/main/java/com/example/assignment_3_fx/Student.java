...
public abstract class Student implements Comparable<Student> {
    ...
    private static final int FRESHMAN_INT = 0;
    private static final int SOPHOMORE_INT = 3;
    private static final int JUNIOR_INT = 1;
    private static final int SENIOR_INT = 2;
